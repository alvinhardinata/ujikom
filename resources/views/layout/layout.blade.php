    ...
    <body  class="main-body light-theme app sidebar-mini active leftmenu-color">
					...
					<div class="main-header-right">
						<div class="nav nav-item  navbar-nav-right ml-auto">
							<div class="dropdown main-profile-menu nav nav-item nav-link">
								<a class="profile-user d-flex" href=""><img src="/gambar/bangunan.png">
								...
								<div class="dropdown-menu shadow">
									<div class="main-header-profile header-img">
										<div class="main-img-user"><img src="/gambar/bangunan.png"></div>
						...
						<div class="tab-pane active" id="side1">
							<div class="card-body text-center">
								<div class="dropdown user-pro-body">
									<div class="">
										<img class="avatar avatar-xl brround mx-auto text-center" src="/gambar/bangunan.png"><span class="avatar-status profile-status bg-green"></span>
									</div>
		...
		<div class="main-footer ht-40">
			<div class="container-fluid pd-t-0-f ht-100p">
				<span>Copyright © 2021 <a href="#">SMK ASSLAAM BANDUNG</a></span>
			</div>
		</div>
		<!-- Footer closed -->
        <!-- Back-to-top -->
